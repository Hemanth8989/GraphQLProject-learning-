...
namespace GraphQLProject.Migrations
{
    ...
    public partial class seeddata1 : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                table: "Reservations",
                columns: new[] { "Id", "CustomerName", "Email", "PartySize", "PhoneNumber", "ReservationDate", "SpecialRequests" },
                values: new object[,]
                {
                    { 1, "John Doe", "johndoe@example.com", 2, "555-123-4567", new DateTime(2026, 3, 21, 19, 0, 0, 0, DateTimeKind.Unspecified), "No nuts in the dishes, please." },
                    { 2, "Jane Smith", "janesmith@example.com", 4, "555-987-6543", new DateTime(2026, 3, 24, 20, 30, 0, 0, DateTimeKind.Unspecified), "Gluten-free options required." },
                    { 3, "Michael Johnson", "michaeljohnson@example.com", 6, "555-789-0123", new DateTime(2026, 3, 28, 18, 0, 0, 0, DateTimeKind.Unspecified), "Celebrating a birthday." }
                });
